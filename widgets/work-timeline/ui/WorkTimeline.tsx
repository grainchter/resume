        ...
        {workHistory.map((entry, index) => (
          ...
          >
            <div className="flex md:flex-col items-center md:items-start gap-3 md:gap-0">
              <div className="w-4 h-4 rounded-full bg-primary border-4 border-primary/30 flex-shrink-0"></div>
              <div className="flex-1 md:flex-none md:w-0.5 md:h-full bg-gradient-to-b from-primary/50 to-transparent md:ml-1.5 h-0.5 md:h-auto"></div>
            </div>
