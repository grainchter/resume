...
export async function WorkTimeline() {
  const t = await getTranslations('workHistory');
    ...
    <div>
      ...
      <div className="space-y-8">
        {workHistory.map((entry, index) => (
          <div key={index} className="grid grid-cols-1 md:grid-cols-[auto_1fr] gap-4 md:gap-8">
