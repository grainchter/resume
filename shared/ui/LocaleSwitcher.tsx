    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background: `linear-gradient(135deg, rgba(var(--primary-rgb), 0.2), rgba(var(--primary-rgb), 0.35))`,
          boxShadow: `
            0 0 12px rgba(var(--primary-rgb), 0.3),
            0 0 6px rgba(var(--primary-rgb), 0.15) inset
          `,
      ...
      <label
        ...
        style={{
          ...
          textShadow: locale === 'ru' ? `0 0 6px var(--primary)` : 'none',
        }}
      >
        RU
      </label>
      ...
      <label
        ...
        style={{
          ...
          textShadow: locale === 'en' ? `0 0 6px var(--primary)` : 'none',
        }}
      >
        EN
      </label>
